class Line
{
    ...
    openGLOutput()
    {
        ...
        const n_rgb = normalizeRgb(rgb)
        this.openglCode += `
            glBegin(GL_LINES);
            glColor3f(${n_rgb.r}f,${n_rgb.g}f,${n_rgb.b}f);
                glVertex2f(${startPoint.x}f, -1.0*${startPoint.y}f);
                glVertex2f(${endPoint.x}f, -1.0*${endPoint.y}f);
            glEnd();
        `
